...
*/
 function actio_load_scripts_front(){
    ...
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/vendor/jquery/jquery.min.js', array(), '3.3.7', true );
    ...
    wp_enqueue_script( 'contactme', get_template_directory_uri() . '/js/contact_me.js', array('jquery'), '1.0.0', true );
